...
# Contribute to Ory kratos-nextjs-react-example<!-- omit in toc -->
...
_Please note_: We take Ory kratos-nextjs-react-example's security and our users'
trust very seriously. If you believe you have found a security issue in Ory
kratos-nextjs-react-example, please disclose it by contacting us at
security@ory.com.
...
won't clash with Ory kratos-nextjs-react-example's direction. A great way to do
this is via
[Ory kratos-nextjs-react-example Discussions](https://github.com/orgs/ory/discussions)
or the [Ory Chat](https://www.ory.com/chat).

## FAQ

- I am new to the community. Where can I find the
  [Ory Community Code of Conduct?](https://github.com/ory/kratos-nextjs-react-example/blob/master/CODE_OF_CONDUCT.md)

- I have a question. Where can I get
  [answers to questions regarding Ory kratos-nextjs-react-example?](#communication)
...
- I want to talk to other Ory kratos-nextjs-react-example users.
  [How can I become a part of the community?](#communication)

- I would like to know what I am agreeing to when I contribute to Ory
  kratos-nextjs-react-example. Does Ory have
  [a Contributors License Agreement?](https://cla-assistant.io/ory/kratos-nextjs-react-example)

- I would like updates about new versions of Ory kratos-nextjs-react-example.
...
[list of good first issues](https://github.com/ory/kratos-nextjs-react-example/labels/good%20first%20issue).
...
- **Give us a star.** It may not seem like much, but it really makes a
  ...
  kratos-nextjs-react-example. Github stars help the project gain visibility and
  stand out.
...
- **Help with open issues.** We have a lot of open issues for Ory
  kratos-nextjs-react-example and some of them may lack necessary information,
...
kratos-nextjs-react-example, consider joining the mailing list. We will _only_
...
kratos-nextjs-react-example's roadmap and architecture.
...
1. Add a descriptive prefix to commits. This ensures a uniform commit history
   ...
   [Convential Commits configuration](https://github.com/ory/kratos-nextjs-react-example/blob/master/.github/workflows/conventional_commits.yml)
...
[Contributor License Agreement](https://cla-assistant.io/ory/kratos-nextjs-react-example).
...
git clone git@github.com:ory/ory/kratos-nextjs-react-example.git

# Next you add a git remote that is your fork:
git remote add fork git@github.com:<YOUR-GITHUB-USERNAME-HERE>/ory/kratos-nextjs-react-example.git
